# Cadence Obsidian — Design System
# Generated by /cc-design:extract https://choosecadence.pages.dev/
# Source: Phase 1 (URL scan) + Phase 2 (Stitch resolution)
...
- Manrope for anything that needs to feel branded; Inter for data/body
